  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="轮播图地址" width="200">
          <template #default="scope">
            <el-image :src="scope.row.url" style="width: 100px; height: 60px;"></el-image>
          </template>
        </el-table-column>
        <el-table-column align="left" label="轮播图介绍" prop="description" width="200" />
        <el-table-column align="left" label="跳转路径" prop="path" width="120" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="100px">
		<el-button slot="trigger" size="small" type="primary" @click="openchooseimg">选择图片</el-button>
        <el-form-item label="轮播图地址:"  prop="url" >
			<ChooseImg ref="chooseImgRef" @enter-img="enterImg"></ChooseImg>
...
const getTableData = async() => {
  ...
  if (table.code === 0) {
	...
	console.log("这里是表格数据",tableData.value)
